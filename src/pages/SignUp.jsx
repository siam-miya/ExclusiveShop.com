        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[4fr_3fr] gap-5 xl:gap-10 justify-between items-center">
          ...
          <div className="p-10 md:p-20 xl:px-[130px] xl:py-20">
            <form action="">
              ...
              <p className="text-gray-600 text-4 leading-6 pt-[34px] text-center flex items-center justify-center gap-3 font-medium">
                Already have account?{" "}
                <Link
                  className="text-[#000000] text-4 leading-6 border-b border-b-[#7d8184] font-bold"
                  to={"/login"}
                >
                  Log in
                </Link>{" "}
